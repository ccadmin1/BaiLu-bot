...
NORGE_IMG = f"https://telegra.ph/file/51da3af3529767c4b7169.jpg"

IMDB_TEMPLATE = """<b>🏷 ᴛɪᴛʟᴇ</b>: <a href={url}>{title}</a>
⌗ ɢᴇɴʀᴇs: {genres}
✤ ʀᴇʟᴇᴀsᴇ ɪɴғᴏ : {release_date}
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="🔰 Main Group 🔰",url="https://t.me/+vfpm8yc7RKRiNTE1")]
            )
        btn.insert(0,
            [InlineKeyboardButton(text="⚜️ Backup Channel ⚜️",url="https://t.me/+QbsY_JnEoXZlN2E1"),
             InlineKeyboardButton(text="🧲 Backup Group 🧲",url="https://t.me/+vUrK_FA97m1hODAy")]
        )
    else:
        btn.append(
