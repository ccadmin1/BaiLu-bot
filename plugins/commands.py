...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡️ Main Channel ⚡️', url="https://t.me/+eyLC_ZNoehZhOWI1"),
                InlineKeyboardButton('🔰 Online Movies 🔰', url="https://t.me/+buH4bFYA1_ViYTlk")
            ],
            [
                InlineKeyboardButton('⚜️ Backup Channel ⚜️', url="https://t.me/+bsgyITMkFtozYjBl"),
                InlineKeyboardButton('🧲 Backup Group 🧲', url="https://t.me/cinemacollections_group")
            ],
            ]
    ...
    if len(message.command) != 2:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚜️ Backup Channel ⚜️', url='https://t.me/+QbsY_JnEoXZlN2E1'),
            InlineKeyboardButton('🧲 Backup Group 🧲', url='https://t.me/+vUrK_FA97m1hODAy')
            ],[
...
async def bot(bot, message):
    buttons = [[
        ...
        InlineKeyboardButton("🔰 Main Group 🔰", url='https://t.me/+vfpm8yc7RKRiNTE1')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_chat_action("typing")
...
async def update(bot, message):
    ...
    await message.reply_chat_action("typing")
    await message.reply_photo(
        photo="https://telegra.ph/file/51da3af3529767c4b7169.jpg",
...
async def cmd(bot, message):
    buttons = [[
        ...
        InlineKeyboardButton("🔰 Main Group 🔰", url='https://t.me/+vUrK_FA97m1hODAy')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_photo(
        photo="https://telegra.ph/file/51da3af3529767c4b7169.jpg",
